...
const SvgMiscMacOsFinderDotted = ({ title, titleId, ...props }) => (
  <svg
    width="1em"
    height="1em"
    viewBox="0 0 24 24"
  ...
  >
    ...
    <rect
      ...
      height={1}
      rx={0.5}
      transform="matrix(1 0 0 -1 13 16)"
      fill="currentColor"
    />
    <rect
      width={1}
    ...
    <rect
      ...
      height={1}
      rx={0.5}
      transform="matrix(1 0 0 -1 20 19)"
      fill="currentColor"
    />
    <rect
      width={1}
...
export default SvgMiscMacOsFinderDotted;
